...
<head>
    <meta charset="utf-8">
    <title>Where Is My Home | Notice Write</title>
                    ...
                    <div class="col-12 col-md-9 col-lg-7 col-xl-6">
                        <div class="card" style="border-radius: 15px;">
                            <div class="card-body p-5"> 
                                ...
                                <!-- 공지사항 작성 폼 -->
                                <h2 class="text-uppercase text-center mb-5">공지사항 작성</h2>
                                ...
                                <input type="hidden" name="action" value="write">
                                    ...
                                    <div class="form-outline mb-4">
                                        ...
                                        <textarea name="content" class="form-control form-control-lg" id="content" cols="30" rows="10"></textarea>
                                    </div>
