...
<head>
    <meta charset="utf-8">
    <title>Where Is My Home | Sign Up</title>
                    ...
                    <div class="col-12 col-md-9 col-lg-7 col-xl-6">
                        <div class="card" style="border-radius: 15px;">
                            <div class="card-body p-5">
                                ...
                                <form method="post" action="/member/join" id="registerForm">
                                    ...
                                    <div class="d-flex justify-content-center">
                                        <a type="button" id='joinBTN'
                                            class="btn btn-success btn-block btn-lg gradient-custom-4 text-white">가입 하기</a>
                                    </div>

                                    <p class="text-center text-muted mt-5 mb-0">이미 아이디가 있으신가요? <a href="/"
                                            class="fw-bold text-body"><u>로그인 하러 가기</u></a></p>
